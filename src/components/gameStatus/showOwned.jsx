...
import DeleteOwned from './deleteOwned';
...
// Function to update the local state when a game is deleted
    ...
    // Fetch the updated games and set the state
        ...
        <div>
            <div className="libraryBody">
                <div className="headerSection">
                    <h1 style={{color: "#3E92CC", fontSize: "larger"}}>Games Owned: </h1>
                </div>
                ...
                <div className="gamesContainer">
                    {resultsArray.length > 0 ? (
                        ...
                        <p className='noGamesP'>No games currently owned.</p>
                    )}
                </div>
            </div>
        </div>
